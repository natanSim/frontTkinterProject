from helper import show_welcome_message_to_user, show_message_to_user, get_name_from_user, game, get_input_from_user, get_player_data, \
    get_winner, add_player_data_to_table, show_player_data, show_players_table, get_random_number
...
def main():
    ...
    for i in range(number_of_player):
        ...
        player_game_result = game(number_to_guess)
        player_data = get_player_data(name, player_game_result)
        players_table = add_player_data_to_table(players_table, player_data)
        show_player_data(player_data)
